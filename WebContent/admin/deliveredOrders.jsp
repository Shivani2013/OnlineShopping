...
<body>
<div style="color: blue; text-align: center; font-size: 30px;">Delivered Orders <i class='fas fa-dolly'></i></div>
<hr>
...
<table id="customers">
       ...
       try
       {
    	   ...
    	   ResultSet rs=st.executeQuery("select * from cart where orderDate is not NULL and status='Delivered'");
    	   while(rs.next())
    	   {
