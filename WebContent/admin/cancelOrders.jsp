...
<body>
<div style="color: blue; text-align: center; font-size: 30px;">Cancel Orders <i class='fas fa-window-close'></i></div>
...
<table id="customers">
       ...
       try
       {
    	   ...
    	   ResultSet rs=st.executeQuery("select * from cart where orderDate is not NULL and status='Cancel'");
    	   while(rs.next())
    	   {
