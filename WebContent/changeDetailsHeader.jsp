...
<body>  
    <div class="topnav sticky bg">
    <h2><a href="home.jsp"><i class='fas fa-arrow-circle-left'>Back </i></a></h2>
            <center><h2>Change Details<i class="fa fa-edit"></i></h2></center><br><br>
             <%
            ...
            <a href="changeMobileNumber.jsp">Change Mobile No. <i class='fas fa-phone'></i></a>
          </div>
           <br>
           <!--table-->
</body>
