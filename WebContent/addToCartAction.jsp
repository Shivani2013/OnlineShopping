...
try
{
	...
	if(z==1)
	{
		...
		response.sendRedirect("home.jsp?msg=product_exist");
	}
	if(z==0)
	{
		PreparedStatement ps= con.prepareStatement("insert into cart(email,product_id,quantity,price,total,product_name) values(?,?,?,?,?,?)");
